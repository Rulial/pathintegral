			...
			import { TrackballControls } from '../src/components/trackBall.js';
			...
			function init() {
				...
				cube = new THREE.Mesh( new THREE.CubeGeometry( 200, 20, 10 ), new THREE.MeshPhongMaterial( { flatShading: true } ) );
				scene.add( cube );
